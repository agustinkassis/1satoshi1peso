...
class Quote extends React.Component {
  ...
  getShowTween (duration = 3) {
    ...
    timeline.fromTo(this.leftSide.element, 1, {
      opacity: 0,
      scale: 0.3,
    }, {
      origin: 'top right',
    ...
    timeline.fromTo(this.equal, 0.5, {
      opacity: 0,
      x: -20
    }, {
      opacity: 1,
    ...
    timeline.fromTo(this.rightSide.element, 1.2, {
      opacity: 0,
      x: 60,
    }, {
      x: 0,
  ...
  render () {
    return (
      <div ref={comp => { this.element = comp }} className="quote">
        <QuoteSide
          ref={comp => { this.leftSide = comp }}
        ...
        <span
          ref={comp => { this.equal = comp }}
          style={{ opacity: this.props.opacity }}
          className="equal">=
        </span>

        <QuoteSide
          ref={comp => { this.rightSide = comp }}
          opacity={ this.props.opacity }
          className="right"
